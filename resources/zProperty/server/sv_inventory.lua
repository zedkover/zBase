...
function getTotalInventoryWeight(plate)
  local total
  TriggerEvent(
    "zProperty_chest:getSharedDataStore",
    plate,
    function(store)
...
ESX.RegisterServerCallback("zProperty_chest:getInventoryV",function(source, cb, plate)
      TriggerEvent("zProperty_chest:getSharedDataStore", plate, function(store)
      local blackMoney = 0
      local money = 0
      local items = {}
      local weapons = {}
...
RegisterServerEvent("zProperty_chest:getItem")
AddEventHandler(
  "zProperty_chest:getItem",
    ...
    if type == "item_standard" then
      ...
      --if targetItem.limit == -1 or ((targetItem.count + count) <= targetItem.limit) then
        TriggerEvent("zProperty_chest:getSharedDataStore",plate,function(store)
            ...
            TriggerClientEvent("zPropertyInv:refreshChestInventory", _source, data, blackMoney, items, weapons, money)
          end
        )
      --else
...
RegisterServerEvent("zProperty_chest:putItem")
AddEventHandler(
  "zProperty_chest:putItem",
...
ESX.RegisterServerCallback(
  "zProperty_chest:getPlayerInventory",
  function(source, cb)
