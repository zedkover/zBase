Locales['sc'] = {
  ...
  ['gave_account_money'] = '你将 ~b~$%s~s~ (%s) 给予 ~y~%s~s~',
  ['received_account_money'] = '你收到了~b~$%s~s~ (%s) 来自 ~b~%s~s~',
  ['amount_invalid'] = '无效数量',
  ...
  ['threw_account'] = '你丢弃了~b~$%s~s~~b~%s~s~',
  ...
  -- Salary related
  ['received_salary'] = '你收到了你的工资: ~b~$%s~s~',
  ['received_help'] = '鉴于你良好的表现，系统赠送给你一些奖励: ~b~$%s~s~',
