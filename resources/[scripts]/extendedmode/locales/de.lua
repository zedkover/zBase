Locales['de'] = {
  ...
  ['gave_account_money'] = 'du gibst ~b~$%s~s~ (%s) an ~y~%s~s~',
  ['received_account_money'] = 'du empfängst ~b~$%s~s~ (%s) von ~b~%s~s~',
  ...
  ['threw_account'] = 'du wirfst ~b~$%s~s~ ~b~%s~s~ weg',
  ...
  -- Salary related
  ['received_salary'] = 'du hast dein Gehalt erhalten: ~b~$%s~s~',
  ['received_help'] = 'du hast deine Sozialhilfe erhalten: ~b~$%s~s~',
