Locales['sv'] = {
  ...
  ['gave_account_money'] = 'du gav ~b~%s SEK~s~ (%s) till ~y~%s~s~',
  ['received_account_money'] = 'du tog emot ~b~%s SEK~s~ (%s) från ~b~%s~s~',
  ...
  ['threw_account'] = 'du kastade ~b~%s SEK~s~ ~b~%s~s~',
  ...
  -- Salary related
  ['received_salary'] = 'du har mottagit din lön på ~b~%s SEK~s~',
  ['received_help'] = 'du har mottagit bidrag på ~b~%s SEK~s~',
