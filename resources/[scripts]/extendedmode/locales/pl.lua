Locales['pl'] = {
  ...
  ['gave_account_money'] = 'dajesz ~b~%s$~s~ (%s) dla ~y~%s~s~',
  ['received_account_money'] = 'otrzymujesz ~b~%s$~s~ (%s) od ~b~%s~s~',
  ...
  ['threw_account'] = 'wyrzuciłeś/aś ~b~$%s~s~ ~b~%s~s~',
  ...
  -- Salary related
  ['received_salary'] = 'otrzymałeś wynagrodzenie: ~b~%s$~s~',
  ['received_help'] = 'otrzymałem zapomogę: ~b~$%s~s~',
