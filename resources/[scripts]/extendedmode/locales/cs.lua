Locales['cs'] = {
  ...
  ['gave_account_money'] = 'dali jste ~b~$%s~s~ (%s) ~y~%s~s~',
  ['received_account_money'] = 'obdrželi jste ~b~$%s~s~ (%s) od ~b~%s~s~',
  ...
  ['threw_account'] = 'vyhodil jsi ~b~$%s~s~ ~b~%s~s~',
  ...
  -- Salary related 
  ['received_salary'] = 'obdrželi jste výplatu: ~b~$%s~s~', 
  ['received_help'] = 'obdrželi jste sociální dávku: ~b~$%s~s~', 
