Locales['br'] = {
  ...
  ['gave_account_money'] = 'voce deu ~b~$%s~s~ (%s) para ~y~%s~s~',
  ['received_account_money'] = 'voce recebeu ~b~$%s~s~ (%s) de ~b~%s~s~',
  ...
  ['threw_account'] = 'você jogou ~b~$%s~s~ ~b~%s~s~',
  ...
  -- Salary related
  ['received_salary'] = 'voce recebeu seu salário: ~b~$%s~s~ ',
  ['received_help'] = 'voce recebeu seu cheque de bem-estar: ~b~$%s~s~ ',
