Locales['es'] = {
  ...
  ['gave_account_money'] = 'diste ~b~$%s~s~ (%s) a ~y~%s~s~',
  ['received_account_money'] = 'recibiste ~b~$%s~s~ (%s) de ~b~%s~s~',
  ...
  ['threw_account'] = 'tiraste ~b~$%s~s~ ~b~%s~s~',
  ...
  -- Salary related
  ['received_salary'] = 'recibiste tu salario: ~b~$%s~s~',
