Locales['tc'] = {
  ...
  ['gave_account_money'] = '您將 ~b~$%s~s~ (%s) 给予 ~y~%s~s~',
  ['received_account_money'] = '您收到了~b~$%s~s~ (%s) 来自 ~b~%s~s~',
  ...
  ['threw_account'] = '您丟棄了~b~$%s~s~~b~%s~s~',
  ...
  -- Salary related
  ['received_salary'] = '您收到您的薪水: ~b~$%s~s~',
  ['received_help'] = '由於您表現良好，系統給予您一些獎勵: ~b~$%s~s~',
