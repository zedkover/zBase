Locales['fi'] = {
  ...
  ['gave_account_money'] = 'sinä annoit ~b~$%s~s~ (%s) henkilölle ~y~%s~s~',
  ['received_account_money'] = 'sinä sait ~b~$%s~s~ (%s) henkilöltä ~b~%s~s~',
  ...
  ['threw_account'] = 'you threw ~b~$%s~s~ ~b~%s~s~',
  ...
  -- Salary related
  ['received_salary'] = 'sinä vastaanotit palkkaa: ~b~$%s~s~',
  ['received_help'] = 'sinä vastaanotit valtion tukea: ~b~$%s~s~',
