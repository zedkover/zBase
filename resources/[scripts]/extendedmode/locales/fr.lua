Locales['fr'] = {
  ...
  ['gave_account_money'] = 'vous avez donné ~b~$%s~s~ (%s) à ~y~%s~s~',
  ['received_account_money'] = 'vous avez reçu ~b~$%s~s~ (%s) par ~b~%s~s~',
  ...
  ['threw_account'] = 'vous avez jeté ~b~$%s~s~ ~b~%s~s~',
  ...
  -- Salary related
  ['received_salary'] = 'vous avez reçu votre salaire: ~b~$%s~s~',
  ['received_help'] = 'vous avez reçu une aide de l\'état: ~b~$%s~s~',
