Locales['en'] = {
  ...
  ['gave_account_money'] = 'you gave ~b~$%s~s~ (%s) to ~y~%s~s~',
  ['received_account_money'] = 'you received ~b~$%s~s~ (%s) from ~b~%s~s~',
  ...
  -- Salary related
  ['received_salary'] = 'you received your salary: ~b~$%s~s~',
  ['received_help'] = 'you recieved your welfare check: ~b~$%s~s~',
